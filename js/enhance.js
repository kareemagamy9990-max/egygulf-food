...
(function () {
  ...
  function injectLights() {
    ...
    document.body.appendChild(el('div', 'fx-lights',
    ...
    document.body.appendChild(el('div', 'fx-rays',
    ...
    // 3) سبوت لايت + فينيت
    document.body.appendChild(el('div', 'fx-spot'));
    document.body.appendChild(el('div', 'fx-vignette'));
  }
